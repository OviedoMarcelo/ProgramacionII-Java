...
public class ManejoArrays {
    ...
    public static void main(String[] args) {
        ...
        while (opcion != 0) {
            switch (opcion) {
                case 1 -> mostrarListadoPrecios(precios);
                case 2 -> modificarPrecios(precios);
    ...
    static void mostrarListadoPrecios(double[] precios) {
        for (int i = 0; i < precios.length; i++) {
            System.out.println("Precio producto " + (i + 1) + " $" + precios[i]);
        }
    }
